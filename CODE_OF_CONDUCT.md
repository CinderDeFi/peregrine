...
This is cryptography and consensus code. **Technical disagreement is welcome and
expected** — say plainly when you think something is wrong, and bring the
reasoning. Reviewing a change critically, or pointing out that a security claim
is overstated, is a contribution, not an attack.

What is *not* welcome is making it personal. Critique the design, the code, or
the claim — not the person who wrote it.
...
address listed in the repository's GitHub profile. All complaints will be
